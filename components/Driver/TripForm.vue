<template>
  <v-card elevation="5" v-scroll-reveal="{ delay: 250 }">
    <v-stepper v-model="curr">
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="4">
          <v-card class="mb-12">
            <v-card-text>
              Please enter the number of passenger seats available in your
              vehicle
        ...
        <v-stepper-content step="5">
          <v-card class="mb-12">
            <v-card-text>
              Please review your choices and if everything appears correct,
              press 'Confirm' to create your trip
            </v-card-text>
            ...
            <v-card-text class="text-overline">
              Seats Available:
              <v-chip>
                <v-icon class="mr-2" color="primary">mdi-seat</v-icon>
                {{ seats }}
              </v-chip>
            </v-card-text>
          </v-card>
